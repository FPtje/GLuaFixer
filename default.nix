...
, optparse-applicative, parsec, pretty, stdenv, uu-parsinglib, uuagc
, uuagc-cabal, vector
, pkgs
}:
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    ListLike MissingH mtl optparse-applicative parsec pretty uu-parsinglib
    uuagc uuagc-cabal deepseq
